...
class AllSheetsList extends AbstractSheetsList implements ISearchAnalyzer {
  ...
  addCategory(Category category) {
    ...
    displayedList =
        applyCategories(displayedList);
  }

  removeCategory(Category category) {
    this._categories.remove(category);
    displayedList =
        applyCategories(applyText(baseList));
  }
