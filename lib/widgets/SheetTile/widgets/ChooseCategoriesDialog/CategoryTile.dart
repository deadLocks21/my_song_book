...
class _CategoryTileState extends State<CategoryTile> {
  ...
  Widget build(BuildContext context) {
    checked =
        sheetCategoriesManager.sheet.categories.indexOf(widget.category) == -1
            ? false
            : true;
    return Padding(
      ...
      child: InkWell(
        onTap: () async {
          checked = !checked;
          if (checked)
            await sheetCategoriesManager.add(widget.category);
          else
            await sheetCategoriesManager.remove(widget.category);
          setState(() {});
        },
        child: Row(
          children: [
